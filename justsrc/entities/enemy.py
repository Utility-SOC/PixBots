...
class Enemy(Bot):
    def __init__(self, name, x, y, level=1, ai_class="grunt"):
        super().__init__(name, x, y, hp=50 + (level * 10), sprite="enemy_bot.png")
        self.level = level
    ...
    def update(self, dt, player, combat_system, current_time):
        super().update(dt)
        self.target = player
        ...
        if self.state == "idle":
            if dist < self.detection_range:
                ...
                self.update_movement(self.move_dir[0], self.move_dir[1], dt)
